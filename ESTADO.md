...
- Manifesto `requirements.yaml` YAML con `scripts`, `tasks`, `env`, `dependencies` y campo opcional `python`.
...
- Comando `byper wheel`.
- Soporte expresivo de versión de Python con operadores de comparación (`>=3.12,<3.13`, `^3.12`, `~3.12.4`, `>3.11`, etc.).
...
- Rangos de versión de Python más expresivos (`>=3.12,<3.13`, `^3.12`, `~3.12.4`, `>`, `<`, `<=`, `==`, `!=`).
